<div class="container mt-3 p-5 shadow-lg">
    ...
    <form id="bookingForm" action="/action_page.php">
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="name" placeholder="" name="name" value="<?= $data['orderList']['nama']; ?>">
        </div>
        <div class="mb-3">
            <label for="telp">Nomor HP/Telp:</label>
            <input type="tel" class="form-control" id="telp" placeholder="" value="<?= $data['orderList']['hp']; ?>" name="telp">
        </div>
        <div class="mb-3">
            <label for="tamu">Jumlah tamu:</label>
            <input type="tamu" class="form-control" id="tamu" value="<?= $data['orderList']['jmh_peserta']; ?>" placeholder="" name="tamu">
        </div>
        <div class="mb-3">
            <label for="check-in">Tanggal Check-in:</label>
            <input type="date" class="form-control" id="check-in" placeholder="" name="check-in" value="<?= $data['orderList']['tanggal']; ?>">
        </div>
        <div class="mb-3">
            <label for="hari">Jumlah hari:</label>
            <input type="hari" class="form-control" id="hari" value="<?= $data['orderList']['jmh_hari']; ?>" placeholder="" name="hari">
        </div>
        <div class="mb-3">
            <label for="package">Pilih Package:</label>
            <select class="form-select" id="package" name="package" value="<?= $data['orderList']['nama_package']; ?>">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" value="<?= $data['orderList']['harga_package']; ?>" class="form-control" id="price" min="0" step="0.01" name="price" readonly>
        </div>

        <label for="total">Total Pesanan:</label>
        <div class="input-group mb-3">
            <span class="input-group-text">Rp</span>
            <input type="number" value="<?= $data['orderList']['total_harga']; ?>" value="0" class="form-control" id="total" min="0" step="0.01" name="total" readonly>
        </div>
